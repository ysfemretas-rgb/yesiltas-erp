      ...
      <div className="w-full max-w-md">
        <div className="card space-y-6">
          <div className="text-center space-y-2">
            {!logoError ? (
              <img src="/logo.png" alt="Yeşiltaş" className="w-24 h-24 mx-auto object-contain" onError={() => setLogoError(true)} />
            ) : (
              <div className="w-24 h-24 mx-auto bg-green-600 rounded-xl flex items-center justify-center text-white font-bold text-4xl">Y</div>
            )}
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="input" placeholder="admin@yesiltas.com" required />
            </div>
            <div>
