...
export default function OrtaklıkPage() {
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Ortaklık</h2>
          <p className="text-muted-foreground">Ortaklık ve demirbaş takibi</p>
        </div>
        <Dialog>
